      ...
      <div className="container flex flex-col justify-center px-4 mx-auto md:p-8">
        <div className="flex flex-col divide-y  divide-gray-700">
          <details className='mx-4' >
            <summary style={summaryStyle} className="py-2 outline-none  flex justify-between cursor-pointer  "><h1 className='w-[90%] text-black font-[400] text-[15px] '>I sent  a deposit, whats next?</h1><span className=''><IoIosArrowDown size={25} /></span></summary>
          ...
          <details className='mx-4' >
            <summary style={summaryStyle} className="py-2 outline-none  flex justify-between cursor-pointer  "><h1 className='w-[100%] text-black font-[400] text-[15px] leading-tight '>How long does it takes to exchange the coins?</h1><span className=''><IoIosArrowDown size={25} /></span></summary>
            <div className=" pb-4">
          ...
          <details className='mx-4' >
            <summary style={summaryStyle} className="py-2 outline-none  flex justify-between cursor-pointer  "><h1 className='w-[85%] text-black font-[400] text-[15px]'>What happens if I close the exchange pages ?</h1><span className=''><IoIosArrowDown size={25} /></span></summary>
            <div className=" pb-4">
