...
const Screen3 = () => {
  ...
  return (
    <>
      ...
      <div>
        <div
          className={`fixed z-50 right-60  top-0 w-[65%] h-full overflow-y-auto bg-[#010C22] bg-opacity-97 transition duration-200 ease-in-out transform translate-x-full md:translate-x-0 ${isOpen ? 'opacity-100  -translate-x-0' : 'opacity-0'
            }`}
        >
