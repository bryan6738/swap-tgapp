...
const Home = ({ props }) => {
  ...
  return (
    <>
      ...
      <div
        style={{ backgroundColor: "white", width: "100%", padding: "2rem 0" }}
      >
        <div className="container mx-auto px-4">
          <h2 className="text-3xl text-center mb-6">
            {t("Telegram's Premier")}
            <br /> {t("Cross Chain Exchange")}{" "}
          </h2>
              ...
              <div key={index} className="relative">
                {(card.id === 0 || card.id === 3) && (
                  <img
                    ...
                    alt="Card Shadow"
                    style={{ maxWidth: "130%" }}
                    className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[400%] h-[400%]"
                  />
                )}
